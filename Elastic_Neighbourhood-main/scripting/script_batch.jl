...
# Run
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
tours, opt_tours, computed_distances, opt_distances = @time batch_tours(params_dict,
                                                                        test_indices,
                                                                        tour_data
                                                                        )
# #turn off for HPC

plot_analyse(plot_index, test_indices, tour_data, tours, opt_tours, computed_distances, opt_distances; DPI = 750)
